...
var About = (props) => {
  return (
    <div>
      ...
      <p>This is a weather application build on ReactJS. I have built this by following The Complete React Web App Developer Course from Udemy by Andrew Mead.</p>
